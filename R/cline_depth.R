...
cline_depth <- function(wtr, depths, water = TRUE, Smin = 0.1, seasonal = TRUE,
                         index = FALSE, mixed.cutoff = 1){
  ...
  thermoInd = which.max(abs(drho_dz))  #Find max slope
