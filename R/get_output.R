#' Get AEME output and add to the aeme object
#'
...
get_output <- function(model, aeme_data, path, mod_ctrls, parallel = FALSE,
                        nlev = NULL) {
  ...
  aeme_data <- update_output(aeme_data = aeme_data, new_output = mods)
