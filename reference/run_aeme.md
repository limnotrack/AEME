...
aeme <- aeme |> 
  run_aeme()
#> ℹ Running models... (Have you tried parallelizing?) [2026-04-26 22:37:16]
#> → GLM-AED running... [2026-04-26 22:37:16]
#> ! GLM-AED run FAILED! [2026-04-26 22:37:16]
...
#> 
#>      Wall clock start time :  Sun Apr 26 22:37:16 2026
#> 
#>      Simulation begins...
...
#> ✔ Model run complete! [2026-04-26 22:37:16]
...
aeme |> 
  plot_output()
#> Error in plot_output(aeme): Variable 'HYD_temp' not in output for model(s): glm_aed
```
