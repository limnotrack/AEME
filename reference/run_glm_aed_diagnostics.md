...
aeme <- run_aeme(aeme)
#> ℹ Running models... (Have you tried parallelizing?) [2026-05-07 01:35:24]
#> → GLM-AED running... [2026-05-07 01:35:24]
#> ✔ GLM-AED run successful! [2026-05-07 01:35:27]
#> ✔ Model run complete! [2026-05-07 01:35:27]
...
#> |:------------------------|:---------------|:---------------------------|--------:|-------:|-------:|-------:|------:|:----|
#> |oxygen_state             |OXY_oxy         |O2 (mmol/m3)                |  176.426| 233.713| 240.082| 322.476| 44.025|ok   |
#> |oxygen_state             |OXY_sat         |O2 saturation (%)           |   49.560|  73.770|  75.415|  95.715|  8.487|ok   |
#> |oxygen_fluxes            |OXY_oxy_atm     |Atm O2 flux (mmol/m2/d)     |  -14.134|  11.743|  25.828| 427.104| 44.837|ok   |
#> |oxygen_fluxes            |OXY_oxy_atmv    |Atm O2 flux (vol)           |   -1.688|   0.931|   2.568|  55.752|  5.361|ok   |
#> |oxygen_fluxes            |OXY_oxy_dsf     |SWI O2 flux (mmol/m2/d)     |  -22.252| -14.172| -14.589|  -9.977|  2.428|ok   |
#> |oxygen_fluxes            |OXY_oxy_dsfv    |SOD (vol)                   |   -3.223|  -1.905|  -1.941|  -1.277|  0.388|ok   |
...
#> |nitrogen_state           |NIT_nit         |NO3 (mmol N/m3)             |    2.422|   3.877|   3.774|   4.532|  0.444|ok   |
...
#> |nitrogen_organic         |OGM_donr        |Refractory DON              |    0.528|   1.315|   1.787|   8.946|  1.534|ok   |
#> |nitrogen_organic         |OGM_pon         |PON (mmol N/m3)             |    2.652|   3.218|   3.423|   7.086|  0.671|ok   |
...
#> |nitrogen_transformations |NIT_nitrif      |Nitrification               |    0.000|   0.073|   0.111|   0.923|  0.153|ok   |
#> |nitrogen_sediment_flux   |NIT_amm_dsf     |NH4 SWI flux                |    0.135|   0.532|   0.700|   1.532|  0.514|ok   |
...
#> |phosphorus_fluxes        |OGM_pop_swi     |POP SWI flux                |   -0.093|  -0.028|  -0.032|  -0.022|  0.010|ok   |
...
#> |phyto_biomass            |PHY_green       |Greens                      |    0.305|  19.228|  22.923|  57.195| 17.124|ok   |
#> |phyto_biomass            |PHY_tchla       |Total chl-a (ug/L)          |    0.224|   5.995|   6.944|  17.120|  4.214|ok   |
#> |phyto_biomass            |PHY_tphy        |Total phyto (mmol C/m3)     |    0.786|  20.077|  23.167|  57.071| 14.034|ok   |
#> |phyto_stoichiometry      |PHY_cyano_NtoP  |Cyano N:P                   |   11.499|  48.265|  45.358|  70.907| 14.656|ok   |
#> |phyto_stoichiometry      |PHY_diatom_NtoP |Diatom N:P                  |   11.447|  53.348|  48.831|  70.826| 14.905|ok   |
#> |phyto_stoichiometry      |PHY_green_NtoP  |Green N:P                   |   11.551|  44.797|  42.113|  66.933| 13.263|ok   |
#> |phyto_limitation         |PHY_cyano_fI    |Cyano fI                    |    0.013|   0.243|   0.233|   0.328|  0.060|ok   |
#> |phyto_limitation         |PHY_cyano_fNit  |Cyano fN                    |    0.630|   0.987|   0.951|   0.997|  0.058|ok   |
#> |phyto_limitation         |PHY_cyano_fPho  |Cyano fP                    |    0.000|   0.243|   0.314|   0.997|  0.292|ok   |
#> |phyto_limitation         |PHY_cyano_fT    |Cyano fT                    |    0.438|   0.859|   0.827|   1.058|  0.157|ok   |
#> |phyto_limitation         |PHY_diatom_fI   |Diatom fI                   |    0.030|   0.323|   0.308|   0.407|  0.064|ok   |
#> |phyto_limitation         |PHY_diatom_fNit |Diatom fN                   |    0.631|   0.978|   0.948|   0.997|  0.057|ok   |
#> |phyto_limitation         |PHY_diatom_fPho |Diatom fP                   |    0.000|   0.156|   0.245|   0.994|  0.293|ok   |
#> |phyto_limitation         |PHY_diatom_fT   |Diatom fT                   |    0.638|   1.000|   0.959|   1.000|  0.058|ok   |
#> |phyto_limitation         |PHY_green_fI    |Green fI                    |    0.013|   0.243|   0.233|   0.328|  0.060|ok   |
#> |phyto_limitation         |PHY_green_fNit  |Green fN                    |    0.637|   0.991|   0.955|   1.000|  0.057|ok   |
#> |phyto_limitation         |PHY_green_fPho  |Green fP                    |    0.039|   0.422|   0.440|   0.998|  0.258|ok   |
#> |phyto_limitation         |PHY_green_fT    |Green fT                    |    0.638|   1.000|   0.959|   1.000|  0.058|ok   |
#> |phyto_fluxes             |PHY_gpp         |GPP                         |    0.121|   0.977|   1.458|   6.976|  1.263|ok   |
#> |phyto_fluxes             |PHY_ncp         |NCP                         |   -0.065|   0.836|   1.239|   6.299|  1.157|ok   |
#> |phyto_fluxes             |PHY_set         |Sedimentation               |  -13.444|  -0.881|  -1.624|  -0.180|  2.277|ok   |
#> |phyto_fluxes             |PHY_upt_nh4     |NH4 uptake                  |    0.005|   0.037|   0.057|   0.262|  0.049|ok   |
...
#> |sedflux_oxygen_Z         |OXY_oxy_dsf_Z   |SWI O2 exchange (per zone)  |  -34.725| -15.532| -14.741|  -0.025|  7.059|ok   |
#> |sedflux_oxygen_Z         |SDF_Fsed_oxy_Z  |SDF O2 flux (per zone)      |  -38.800| -29.100| -29.100| -19.400|  9.707|ok   |
#> |sedflux_nitrogen_Z       |NIT_amm_dsf_Z   |NH4 SWI flux (per zone)     |    0.034|   0.249|   1.175|   5.206|  1.666|ok   |
...
#> |sedflux_phosphorus_Z     |OGM_poc_swi_Z   |POC SWI flux (per zone)     |  -10.450|  -3.162|  -4.230|  -0.983|  2.382|ok   |
...
#> |sedflux_organic_Z        |PHY_phy_swi_c_Z |Phyto SWI C (per zone)      | -133.755|  -5.460| -10.617|  -0.468| 18.217|ok   |
