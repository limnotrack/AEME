...
aeme <- run_aeme(aeme)
#> ℹ Running models... (Have you tried parallelizing?) [2026-06-02 03:59:31]
#> → GLM-AED running... [2026-06-02 03:59:31]
#> ✔ GLM-AED run successful! [2026-06-02 03:59:33]
#> ✔ Model run complete! [2026-06-02 03:59:33]
...
#> │phyto_stoichiometry│PHY_green_NtoP│ Green N:P             │ 27.2│   46 │  47│ 109│  10│OUT OF RANGE│
#> └───────────────────┴──────────────┴───────────────────────┴─────┴──────┴────┴────┴────┴────────────┘
#> ── Full summary ────────────────────────────────────────────────────────────────
#> ┌────────────────────────┬───────────────┬───────────────────────────┬────────┬────────┬────────┬─────────┬────────┬────────────┐
#> │ group                  │ variable      │ label                     │ min    │ median │ mean   │ max     │ sd     │ flag       │
...
#> │ oxygen_fluxes          │ OXY_oxy_dsfv  │ SOD (vol)                 │ -3.23  │ -1.95  │ -1.99  │ -1.17   │ 0.375  │ ok         │
...
#> │ phyto_biomass          │ PHY_tphy      │ Total phyto (mmol C/m3)   │ 1.89   │ 11.2   │ 16.9   │   50    │   14   │ ok         │
#> │ phyto_stoichiometry    │ PHY_cyano_NtoP│ Cyano N:P                 │ 26.2   │ 49.3   │ 50.6   │ 99.5    │  9.6   │ ok         │
#> │ phyto_stoichiometry    │PHY_diatom_NtoP│ Diatom N:P                │ 30.4   │   55   │ 54.3   │ 82.8    │ 8.13   │ ok         │
#> │ phyto_stoichiometry    │ PHY_green_NtoP│ Green N:P                 │ 27.2   │   46   │   47   │  109    │   10   │OUT OF RANGE│
#> │ phyto_limitation       │ PHY_cyano_fI  │ Cyano fI                  │ 0.0188 │ 0.251  │ 0.237  │ 0.342   │ 0.0632 │ ok         │
...
#> │ phyto_limitation       │PHY_diatom_fNit│ Diatom fN                 │ 0.00811│ 0.947  │ 0.928  │ 0.998   │ 0.0775 │ ok         │
#> │ phyto_limitation       │PHY_diatom_fPho│ Diatom fP                 │    0   │ 0.124  │ 0.127  │ 0.585   │ 0.124  │ ok         │
#> │ phyto_limitation       │ PHY_diatom_fT │ Diatom fT                 │ 0.613  │    1   │ 0.96   │    1    │ 0.0583 │ ok         │
#> │ phyto_limitation       │ PHY_green_fI  │ Green fI                  │ 0.0188 │ 0.251  │ 0.237  │ 0.342   │ 0.0632 │ ok         │
...
#> │ phyto_limitation       │ PHY_green_fT  │ Green fT                  │ 0.613  │    1   │ 0.96   │    1    │ 0.0583 │ ok         │
#> │ phyto_fluxes           │ PHY_gpp       │ GPP                       │    0   │ 0.588  │ 0.852  │ 3.94    │ 0.792  │ ok         │
#> │ phyto_fluxes           │ PHY_ncp       │ NCP                       │ -0.0659│ 0.478  │ 0.738  │ 3.74    │ 0.743  │ ok         │
#> │ phyto_fluxes           │ PHY_set       │ Sedimentation             │ -1.81  │ -0.383 │ -0.568 │ -0.147  │ 0.433  │ ok         │
#> │ phyto_fluxes           │ PHY_upt_nh4   │ NH4 uptake                │ 0.00553│ 0.0231 │ 0.0336 │ 0.145   │ 0.0308 │ ok         │
#> │ phyto_fluxes           │ PHY_upt_no3   │ NO3 uptake                │    0   │    0   │7.11e-09│ 2.38e-06│ 1.3e-07│ ok         │
#> │ phyto_fluxes           │ PHY_upt_po4   │ PO4 uptake                │    0   │0.000262│0.000391│ 0.00635 │0.000575│ ok         │
